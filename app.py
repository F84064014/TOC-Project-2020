...
machine = TocMachine(
    states=["user", "state_hello", "state_search", "state_random_news", "state_exit", "state_count", "state_content", "state_scrapy_search", "state_scrapy_count", "state_next"],
    transitions=[
        {
            "trigger": "advance",
            "source": "user",
        ...
        },
        {
            ...
            "source": ["state_count", "state_content", "state_next"],
            "dest": "state_search"
        },
        {
            "trigger": "advance",
